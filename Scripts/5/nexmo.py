...
| \ | |                           |  _ \      | |                       / ____| |             | |            {red}
|  \| | ____{red}XPROAD_{res}  ____   ___   | |_) | __ _| | __ _ _ __   ___ ___  | |    | |__   ___  ___| | _____ _ __{ble} 
...
{gr}|_| \_|\___/_/\_\_| |_| |_|\___/  |____/ \__,_|_|\__,_|_| |_|\___\___|  \_____|_| |_|\___|\___|_|\_\___|_|{gr}
              {gr}                                                   {wh}   Laravel Monster {red}V2{res}
''')
link = input(f"\n{gr}Give Me Nexmo_List.txt\{red}Xproad>{gr} ${res} ")
