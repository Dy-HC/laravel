...
print(f'''
  ...
  / ___/___  ____  ____/ /__{gr}xproad{red}__(_)___/ /  /   |  ____  (_)  / ____/ /_  ___  _____/ /_____  _____ {red}
...
/____/\___/_/ /_/\__,_/\__, /_/  /_/\__,_/  /_/  |_/ .___/_/   \____/_/ /_/\___/\___/_/|_|\___/_/     {yl}
                      /____/                      /_/                              {gr}{wh} Laravel Monster {red}V2{res}                  
''')

link = input(f'{gr}Give Me Your List.txt{res}\{red}Xproad> {gr}${res} ')
address = input(f'{gr}Give Me Your Adress{res}\{red}Xproad> {gr}${res} ')
